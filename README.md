...
│       └── frontend-design/
│
├── project-01-study-notes-skill/              # Building a custom skill with skill-creator
│   ├── .claude/skills/weekly-study-notes/
│   ├── inputs/raw_class_notes.txt
│   ├── outputs/study-notes-ai-agents.md
│   └── README.md
│
├── project-02-connectors-drive-gmail/         # Connecting Google Drive & Gmail (read-only)
...
│   └── README.md
│
├── project-03-compound-skill-connector/       # Compounding: Drive Connector + Custom Skill
│   ├── .claude/skills/weekly-study-notes/
│   ├── inputs/drive_source_notes.md
│   ├── outputs/study-notes-ai-agents-week2.md
│   └── README.md
│
├── project-04-skill-portability-claude-code/  # Skill portability: Claude.ai -> Claude Code CLI
│   ├── .claude/skills/weekly-study-notes/
│   ├── inputs/raw_llm_notes.txt
│   ├── outputs/study-notes-llms.md
│   └── README.md
│
└── project-05-skill-security-audit/           # Auditing 3rd-party community skills
...
| :--- | :--- | :--- | :--- |
| [**Project 1**](./project-01-study-notes-skill/README.md) | **Skill Creation** (`skill-creator`) | *"Use the skill-creator skill to build me a weekly study-notes skill..."* | [`study-notes-ai-agents.md`](./project-01-study-notes-skill/outputs/study-notes-ai-agents.md) |
| [**Project 2**](./project-02-connectors-drive-gmail/README.md) | **Cloud Connectors** (Drive & Gmail) | *"Find my most recent document in my Drive..."* / *"Summarize my most recent email thread..."* | [`ai_agents_guide_summary.md`](./project-02-connectors-drive-gmail/outputs/ai_agents_guide_summary.md)<br>[`email_thread_summary.md`](./project-02-connectors-drive-gmail/outputs/email_thread_summary.md) |
| [**Project 3**](./project-03-compound-skill-connector/README.md) | **Compound Workflow** (Skill + Connector) | *"Find this week's class notes in my Drive and make study notes from them."* | [`study-notes-ai-agents-week2.md`](./project-03-compound-skill-connector/outputs/study-notes-ai-agents-week2.md) |
| [**Project 4**](./project-04-skill-portability-claude-code/README.md) | **Skill Portability** (Claude Code CLI) | *"Use this skill to make study notes from..."* | [`study-notes-llms.md`](./project-04-skill-portability-claude-code/outputs/study-notes-llms.md) |
| [**Project 5**](./project-05-skill-security-audit/README.md) | **Security Audit** (3rd-Party Skills) | *"Read the skill I just installed and tell me, in plain language, exactly what it instructs you to do..."* | [`frontend-design-review.md`](./project-05-skill-security-audit/outputs/frontend-design-review.md) |

---

## Detailed Project Descriptions

### [Project 1: Weekly Study-Notes Skill Creation](./project-01-study-notes-skill/README.md)
...
### [Project 2: Connectors (Google Drive & Gmail Integration)](./project-02-connectors-drive-gmail/README.md)
...
- **Workflow:**
  ...
  2. Query Google Drive for the most recent PDF document ([`ai_agents_comprehensive_guide.pdf`](./project-02-connectors-drive-gmail/inputs/ai_agents_comprehensive_guide.pdf)) to extract the top 3 facts and a 1-line summary.
...
### [Project 3: Compound Workflow (Drive Connector + Custom Skill)](./project-03-compound-skill-connector/README.md)
...
### [Project 4: Skill Portability (Claude Code CLI Integration)](./project-04-skill-portability-claude-code/README.md)
...
- **Workflow:**
  ...
  3. Run the skill against raw notes covering **Large Language Models (LLMs)**, producing [`study-notes-llms.md`](./project-04-skill-portability-claude-code/outputs/study-notes-llms.md).
- **Key Takeaway:** *"I handed my skill to a friend and it just worked, without me in the room."*

---

### [Project 5: Skill Security Audit & Review](./project-05-skill-security-audit/README.md)
...
2. Create a new skill and copy-paste the contents of [`project-01-study-notes-skill/.claude/skills/weekly-study-notes/SKILL.md`](./project-01-study-notes-skill/.claude/skills/weekly-study-notes/SKILL.md).
